...
// Escape is not here. It was (#404's `closesItemDetail`), as a second reader
// on the same shell listener — until a third claimant made a pairwise guard
// the wrong shape. `escape-claimants.ts` owns it now: one ordered list rather
// than one flag per rival.
