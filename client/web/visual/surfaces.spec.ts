...
const SCREENS = [
  ...
  // banded "near" with a negative cash split) — this capture now shows that
  // pane answered alongside the three still-honest gap panes (#314-#316
  // unpolled). Not permanent: each of those replaces its own gap in turn.
